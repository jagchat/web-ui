...
// //'c' contains function
// function doProcess3(a, b=20, c=function(){return (1 + Math.floor(Math.random() * 6)) ;}){
...
var f = function(){return (1 + Math.floor(Math.random() * 6)) ;};
...
$(function(){
	...
	//doProcess3(1,2,function(){return 30});
	//doProcess3(1,2);
